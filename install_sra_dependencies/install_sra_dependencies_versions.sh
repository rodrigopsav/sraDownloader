...
#-----------------------------#
"
conda install -y -n sra -c conda-forge parallel=20210222
...
#-----------------------------#
"
conda install -y -n sra -c trent dos2unix=7.4.1
...
#------------------------#
"
conda install -y -n sra -c conda-forge sed=4.8
...
#------------------------#
"
conda install -y -n sra -c anaconda git=2.30.2
...
#-------------------------#
"
conda install -y -n sra -c anaconda pigz=2.6
...
#-----------------------------#
"
conda install -y -n sra -c anaconda datamash=1.7
...
#---------------------------------#
"
conda install -y -n sra -c bioconda trimmomatic=0.39
